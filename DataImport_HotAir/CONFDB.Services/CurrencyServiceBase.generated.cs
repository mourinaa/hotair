...
{		
	...
	public partial class CurrencyServiceBase : ServiceBase<Currency, CurrencyKey>
	{
		...
		public static Currency CreateCurrency(System.String _id, System.String _longName, System.Boolean? _enabled, System.Int16? _displayOrder)
		{
			Currency newEntityCurrency = new Currency();
			newEntityCurrency.Id  = _id;
			newEntityCurrency.LongName  = _longName;
			newEntityCurrency.Enabled  = _enabled;
			newEntityCurrency.DisplayOrder  = _displayOrder;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Currency}" /> from the datasource based on the primary key Currency_PK index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="Currency"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Currency GetById(System.String _id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Currency"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Currency GetById(System.String _id, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.CurrencyProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as Currency;
		...
		public virtual TList<Currency> Insert(TList<Currency> entityCollection)
		{
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Currency>(entityCollection));
			}
		...
		public virtual TList<Currency> Update(TList<Currency> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Currency>(entityCollection));
			}
		...
		public virtual TList<Currency> Save(TList<Currency> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Currency>(entityCollection));
			}
		...
		public virtual TList<Currency> Delete(TList<Currency> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Currency>(entityCollection));
			}
		...
		public virtual bool Delete(System.String _id)
		{
			...
			try
            {
				...
				//Delete
				result = dataProvider.CurrencyProvider.Delete(transactionManager, _id);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Currency DeepLoadById(System.String _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Currency entity = GetById(_id);
