...
{		
	...
	public partial class RoleServiceBase : ServiceBase<Role, RoleKey>
	{
		...
		public static Role CreateRole(System.String _name, System.Int32? _userLevel)
		{
			...
			newEntityRole.Name  = _name;
			newEntityRole.UserLevel  = _userLevel;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Role}" /> from the datasource based on the primary key PK_Role index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="Role"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Role GetById(System.Int32 _id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Role"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Role GetById(System.Int32 _id, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.RoleProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as Role;
		...
		/// <returns>Returns a typed collection of <c>Role</c> objects.</returns>
		public virtual TList<Role> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Role</c> objects.</returns>
		public virtual TList<Role> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>Role</c> objects.</returns>
		public virtual TList<Role> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
		...
		/// </summary>
		/// <param name="_id">Role pk id.</param>
		...
		public virtual bool Delete(System.Int32 _id)
		{
			...
			try
            {
				...
				//Delete
				result = dataProvider.RoleProvider.Delete(transactionManager, _id);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Role DeepLoadById(System.Int32 _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Role entity = GetById(_id);
		...
		/// <param name="entity">Role Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Role entity)
		{
