...
{		
	...
	/// All custom implementations should be done in the <see cref="Language"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class LanguageServiceBase : ServiceBase<Language, LanguageKey>
	{
		...
		///</summary>
		public LanguageServiceBase() : base()
		{
		}
		...
		public static Language CreateLanguage(System.String _id, System.String _displayName, System.Int16? _displayOrder)
		{
			...
			newEntityLanguage.Id  = _id;
			newEntityLanguage.DisplayName  = _displayName;
			newEntityLanguage.DisplayOrder  = _displayOrder;
		...
		#region Fields
		private static SecurityContext<Language> securityContext = new SecurityContext<Language>();
		...
		///</summary>
		public static SecurityContext<Language> SecurityContext
		{
			get
			{
		...
		public override Language Get(LanguageKey key)
		{
			return GetById(key.Id);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Language}" /> from the datasource based on the primary key Language_PK index.
		/// </summary>
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetById(System.String _id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Language"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language GetById(System.String _id, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.LanguageProvider.GetById(transactionManager, _id, start, pageLength, out totalCount)   as Language;
		...
		#region GetAll
		/// <summary>
		/// Get a complete collection of <see cref="Language" /> entities.
		/// </summary>
		/// <returns></returns>
		public override TList<Language> GetAll() 
		{
			int totalCount = -1;
		...
		/// <summary>
		/// Get a set portion of a complete list of <see cref="Language" /> entities
		/// </summary>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="totalCount">out parameter, number of total rows in given query.</param>
		/// <returns>a <see cref="TList{Language}"/> </returns>
		public virtual TList<Language> GetAll(int start, int pageLength, out int totalCount) 
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			
			// get this data
			TList<Language> list = null;
			totalCount = -1;
			TransactionManager transactionManager = null; 
            ...
            {	
				...
				//Access repository
				list = dataProvider.LanguageProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a  larger commit
		...
		#region GetPaged
		/// <summary>
		/// Gets a page of <see cref="TList{Language}" /> rows from the DataSource.
		/// </summary>
		/// <param name="totalCount">Out Parameter, Number of rows in the DataSource.</param>
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public virtual TList<Language> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public virtual TList<Language> GetPaged(int start, int pageLength, out int totalCount)
		{
			return GetPaged(null, null, start, pageLength, out totalCount);
		}

		/// <summary>
		/// Gets a page of entity rows with a <see cref="TList{Language}" /> from the DataSource with a where clause and order by clause.
		/// </summary>
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public override TList<Language> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LanguageProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
		...
		public virtual TList<Language> Find(string whereClause)
		{
			int totalCount = -1;
		...
		public override TList<Language> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access repository
				list = dataProvider.LanguageProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
		...
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public virtual TList<Language> Find(IFilterParameterCollection parameters)
		{
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public virtual TList<Language> Find(IFilterParameterCollection parameters, string orderBy)
		{
			int count = 0;
		...
		/// <returns>Returns a typed collection of <c>Language</c> objects.</returns>
		public virtual TList<Language> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				//Access repository
				list = dataProvider.LanguageProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				//if open, rollback, it's possible this is part of a larger commit
		...
		public override bool Insert(Language entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LanguageProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Inserts rows in <see cref="TList{Language}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Language</c> objects in a <see cref="TList{Language}" /> object to Insert.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<Language> Insert(TList<Language> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new Entities.EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Insert
				dataProvider.LanguageProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(Language entity)
		{
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LanguageProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Updates rows in <see cref="TList{Language}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Language</c> objects in a <see cref="TList{Language}" /> object to Update.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Language> Update(TList<Language> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Update
				dataProvider.LanguageProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Language Save(Language entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				dataProvider.LanguageProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Saves rows in <see cref="TList{Language}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Language</c> objects in a <see cref="TList{Language}" /> object to Save.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Language> Save(TList<Language> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Save
				dataProvider.LanguageProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(Language entity)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Persist Entity
				result = dataProvider.LanguageProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// 	public virtual method that Deletes rows in <see cref="TList{Language}" /> to the datasource.
		/// </summary>
		/// <param name="entityCollection"><c>Language</c> objects in a <see cref="TList{Language}" /> object to Delete.</param>
		/// <remarks>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<Language> Delete(TList<Language> entityCollection)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new Entities.EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Language>(entityCollection));
			}
			...
			try
            {
				...
				//Persist Delete
				dataProvider.LanguageProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(LanguageKey key)
		{
		...
		public virtual bool Delete(System.String _id)
		{
			...
			try
            {
				...
				//Delete
				result = dataProvider.LanguageProvider.Delete(transactionManager, _id);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Language> GetByWholesalerIdFromIrWholesaler(System.String _wholesalerId)
		{
			int totalRecords = -1;
			return GetByWholesalerIdFromIrWholesaler(_wholesalerId, 0, defaultMaxRecords, out totalRecords);
		}
		...
		/// <returns>Returns a typed collection of Language objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Language> GetByWholesalerIdFromIrWholesaler(System.String _wholesalerId, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByWholesalerIdFromIrWholesaler");
			TList<Language> list = null;
			TransactionManager transactionManager = null; 
			totalCount = -1;
			try
            {	
				...
				//call data provider
				list = dataProvider.LanguageProvider.GetByWholesalerIdFromIrWholesaler(transactionManager, _wholesalerId, start,  pageLength, out totalCount);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="Language"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="Language"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Language DeepLoadById(System.String _id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadById");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Language entity = GetById(_id);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(Language)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Language entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Language entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="Language"/> object to load.</param>
		...
		/// <param name="childTypes">Language Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Language entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.LanguageProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{Language}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Language)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{Language}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Language> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{Language}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Language)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Language> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{Language}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{Language}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="Language"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<Language> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			TransactionManager transactionManager = null; 
			...
			try
            {
				...
				//Call Deep Load from the Repository
				dataProvider.LanguageProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="Language"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">Language Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Language entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Language entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Save
				result = dataProvider.LanguageProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{Language}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{Language} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<Language> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{Language}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{Language}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">Language Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<Language> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{				
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				NetTiersProvider dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.LanguageProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
