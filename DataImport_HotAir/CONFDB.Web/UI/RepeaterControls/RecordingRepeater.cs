...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>RecordingRepeater</c>
    /// </summary>
	public class RecordingRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:RecordingRepeaterDesigner"/> class.
        /// </summary>
		public RecordingRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is RecordingRepeater))
			{ 
				throw new ArgumentException("Component is not a RecordingRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			RecordingRepeater z = (RecordingRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="RecordingRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(RecordingRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:RecordingRepeater runat=\"server\"></{0}:RecordingRepeater>")]
	public class RecordingRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:RecordingRepeater"/> class.
        /// </summary>
		public RecordingRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(RecordingItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.Recording entity = o as CONFDB.Entities.Recording;
					RecordingItem container = new RecordingItem(entity);
	...
	public class RecordingItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.Recording _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:RecordingItem"/> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="T:RecordingItem"/> class.
        /// </summary>
		public RecordingItem(CONFDB.Entities.Recording entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:CONFDB.Entities.Recording"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public CONFDB.Entities.Recording Entity
        {
            get { return _entity; }
        }
	}
