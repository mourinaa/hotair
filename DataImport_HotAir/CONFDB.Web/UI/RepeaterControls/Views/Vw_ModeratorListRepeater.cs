...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>Vw_ModeratorListRepeater</c>
    /// </summary>
	public class Vw_ModeratorListRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_ModeratorListRepeaterDesigner"/> class.
        /// </summary>
		public Vw_ModeratorListRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is Vw_ModeratorListRepeater))
			{ 
				throw new ArgumentException("Component is not a Vw_ModeratorListRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			Vw_ModeratorListRepeater z = (Vw_ModeratorListRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="Vw_ModeratorListRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(Vw_ModeratorListRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:Vw_ModeratorListRepeater runat=\"server\"></{0}:Vw_ModeratorListRepeater>")]
	public class Vw_ModeratorListRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_ModeratorListRepeater"/> class.
        /// </summary>
		public Vw_ModeratorListRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(Vw_ModeratorListItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.Vw_ModeratorList entity = o as CONFDB.Entities.Vw_ModeratorList;
					Vw_ModeratorListItem container = new Vw_ModeratorListItem(entity);
	...
	public class Vw_ModeratorListItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.Vw_ModeratorList _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_ModeratorListItem"/> class.
        /// </summary>
		public Vw_ModeratorListItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:Vw_ModeratorListItem"/> class.
        /// </summary>
		public Vw_ModeratorListItem(CONFDB.Entities.Vw_ModeratorList entity)
			: base()
		{
			_entity = entity;
		}
