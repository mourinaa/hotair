...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>Vw_CustomerListRepeater</c>
    /// </summary>
	public class Vw_CustomerListRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_CustomerListRepeaterDesigner"/> class.
        /// </summary>
		public Vw_CustomerListRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is Vw_CustomerListRepeater))
			{ 
				throw new ArgumentException("Component is not a Vw_CustomerListRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			Vw_CustomerListRepeater z = (Vw_CustomerListRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="Vw_CustomerListRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(Vw_CustomerListRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:Vw_CustomerListRepeater runat=\"server\"></{0}:Vw_CustomerListRepeater>")]
	public class Vw_CustomerListRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_CustomerListRepeater"/> class.
        /// </summary>
		public Vw_CustomerListRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(Vw_CustomerListItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.Vw_CustomerList entity = o as CONFDB.Entities.Vw_CustomerList;
					Vw_CustomerListItem container = new Vw_CustomerListItem(entity);
	...
	public class Vw_CustomerListItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.Vw_CustomerList _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:Vw_CustomerListItem"/> class.
        /// </summary>
		public Vw_CustomerListItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:Vw_CustomerListItem"/> class.
        /// </summary>
		public Vw_CustomerListItem(CONFDB.Entities.Vw_CustomerList entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets the UserEnabled
        /// </summary>
        /// <value>The UserEnabled.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Boolean UserEnabled
		{
			get { return _entity.UserEnabled; }
		}
        /// <summary>
        /// Gets the RoleId
        /// </summary>
        ...
        /// <summary>
        /// Gets the VerticalDescription
        /// </summary>
        /// <value>The VerticalDescription.</value>
		[System.ComponentModel.Bindable(true)]
		public System.String VerticalDescription
		{
			get { return _entity.VerticalDescription; }
		}
