...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>RatedCdrRepeater</c>
    /// </summary>
	public class RatedCdrRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:RatedCdrRepeaterDesigner"/> class.
        /// </summary>
		public RatedCdrRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is RatedCdrRepeater))
			{ 
				throw new ArgumentException("Component is not a RatedCdrRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			RatedCdrRepeater z = (RatedCdrRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="RatedCdrRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(RatedCdrRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:RatedCdrRepeater runat=\"server\"></{0}:RatedCdrRepeater>")]
	public class RatedCdrRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:RatedCdrRepeater"/> class.
        /// </summary>
		public RatedCdrRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(RatedCdrItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.RatedCdr entity = o as CONFDB.Entities.RatedCdr;
					RatedCdrItem container = new RatedCdrItem(entity);
	...
	public class RatedCdrItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.RatedCdr _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:RatedCdrItem"/> class.
        /// </summary>
		public RatedCdrItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:RatedCdrItem"/> class.
        /// </summary>
		public RatedCdrItem(CONFDB.Entities.RatedCdr entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets the ConferenceEndTime
        /// </summary>
        /// <value>The ConferenceEndTime.</value>
		[System.ComponentModel.Bindable(true)]
		public System.DateTime? ConferenceEndTime
		{
			get { return _entity.ConferenceEndTime; }
		}
        /// <summary>
        /// Gets the ConferenceElapsedTime
        /// </summary>
        /// <value>The ConferenceElapsedTime.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Int32? ConferenceElapsedTime
		{
			get { return _entity.ConferenceElapsedTime; }
		}
        /// <summary>
        /// Gets the StartTime
        /// </summary>
        ...
        /// <summary>
        /// Gets the RetailTotalCredit
        /// </summary>
        /// <value>The RetailTotalCredit.</value>
		[System.ComponentModel.Bindable(true)]
		public System.Decimal? RetailTotalCredit
		{
			get { return _entity.RetailTotalCredit; }
		}
        /// <summary>
        ...
        /// <summary>
        /// Gets a <see cref="T:CONFDB.Entities.RatedCdr"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public CONFDB.Entities.RatedCdr Entity
        {
            get { return _entity; }
        }
	}
