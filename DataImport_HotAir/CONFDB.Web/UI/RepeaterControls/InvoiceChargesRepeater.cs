...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>InvoiceChargesRepeater</c>
    /// </summary>
	public class InvoiceChargesRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:InvoiceChargesRepeaterDesigner"/> class.
        /// </summary>
		public InvoiceChargesRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is InvoiceChargesRepeater))
			{ 
				throw new ArgumentException("Component is not a InvoiceChargesRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			InvoiceChargesRepeater z = (InvoiceChargesRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="InvoiceChargesRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(InvoiceChargesRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:InvoiceChargesRepeater runat=\"server\"></{0}:InvoiceChargesRepeater>")]
	public class InvoiceChargesRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:InvoiceChargesRepeater"/> class.
        /// </summary>
		public InvoiceChargesRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(InvoiceChargesItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.InvoiceCharges entity = o as CONFDB.Entities.InvoiceCharges;
					InvoiceChargesItem container = new InvoiceChargesItem(entity);
	...
	public class InvoiceChargesItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.InvoiceCharges _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:InvoiceChargesItem"/> class.
        /// </summary>
		public InvoiceChargesItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:InvoiceChargesItem"/> class.
        /// </summary>
		public InvoiceChargesItem(CONFDB.Entities.InvoiceCharges entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:CONFDB.Entities.InvoiceCharges"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public CONFDB.Entities.InvoiceCharges Entity
        {
            get { return _entity; }
        }
	}
