...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>CustomerTransactionRepeater</c>
    /// </summary>
	public class CustomerTransactionRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:CustomerTransactionRepeaterDesigner"/> class.
        /// </summary>
		public CustomerTransactionRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is CustomerTransactionRepeater))
			{ 
				throw new ArgumentException("Component is not a CustomerTransactionRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			CustomerTransactionRepeater z = (CustomerTransactionRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="CustomerTransactionRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(CustomerTransactionRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:CustomerTransactionRepeater runat=\"server\"></{0}:CustomerTransactionRepeater>")]
	public class CustomerTransactionRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:CustomerTransactionRepeater"/> class.
        /// </summary>
		public CustomerTransactionRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(CustomerTransactionItem))]
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
            ...
            {
					CONFDB.Entities.CustomerTransaction entity = o as CONFDB.Entities.CustomerTransaction;
					CustomerTransactionItem container = new CustomerTransactionItem(entity);
	...
	public class CustomerTransactionItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private CONFDB.Entities.CustomerTransaction _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:CustomerTransactionItem"/> class.
        /// </summary>
		public CustomerTransactionItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:CustomerTransactionItem"/> class.
        /// </summary>
		public CustomerTransactionItem(CONFDB.Entities.CustomerTransaction entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:CONFDB.Entities.CustomerTransaction"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public CONFDB.Entities.CustomerTransaction Entity
        {
            get { return _entity; }
        }
	}
