...
{	
	...
	///</summary>
	public abstract partial class RoleProviderBaseCore : EntityProviderBase<CONFDB.Entities.Role, CONFDB.Entities.RoleKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, CONFDB.Entities.RoleKey key)
		{
		...
		public override CONFDB.Entities.Role Get(TransactionManager transactionManager, CONFDB.Entities.RoleKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public CONFDB.Entities.Role GetById(System.Int32 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public CONFDB.Entities.Role GetById(System.Int32 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public CONFDB.Entities.Role GetById(TransactionManager transactionManager, System.Int32 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public CONFDB.Entities.Role GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public CONFDB.Entities.Role GetById(System.Int32 _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="CONFDB.Entities.Role"/> class.</returns>
		public abstract CONFDB.Entities.Role GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count);
		...
		/// <returns>a <see cref="CONFDB.Entities.TList&lt;Role&gt;"/></returns>
		public static CONFDB.Entities.TList<Role> Fill(IDataReader reader, CONFDB.Entities.TList<Role> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				CONFDB.Entities.Role c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("Role")
					.Append("|").Append((reader.IsDBNull(((int)CONFDB.Entities.RoleColumn.Id - 1))?(int)0:(System.Int32)reader[((int)CONFDB.Entities.RoleColumn.Id - 1)]).ToString()).ToString();
					...
					))
				{
					...
					c.Name = (System.String)reader[((int)RoleColumn.Name - 1)];
					c.UserLevel = (reader.IsDBNull(((int)RoleColumn.UserLevel - 1)))?null:(System.Int32?)reader[((int)RoleColumn.UserLevel - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="CONFDB.Entities.Role"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="CONFDB.Entities.Role"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, CONFDB.Entities.Role entity)
		{
			if (!reader.Read()) return;
			
			entity.Id = (System.Int32)reader[((int)RoleColumn.Id - 1)];
			entity.Name = (System.String)reader[((int)RoleColumn.Name - 1)];
			entity.UserLevel = (reader.IsDBNull(((int)RoleColumn.UserLevel - 1)))?null:(System.Int32?)reader[((int)RoleColumn.UserLevel - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="CONFDB.Entities.Role"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="CONFDB.Entities.Role"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, CONFDB.Entities.Role entity)
		{
			DataRow dataRow = dataSet.Tables[0].Rows[0];
			
			entity.Id = (System.Int32)dataRow["ID"];
			entity.Name = (System.String)dataRow["Name"];
			entity.UserLevel = Convert.IsDBNull(dataRow["UserLevel"]) ? null : (System.Int32?)dataRow["UserLevel"];
			entity.AcceptChanges();
		}
		#endregion 
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="CONFDB.Entities.Role"/> object to load.</param>
		...
		internal override void DeepLoad(TransactionManager transactionManager, CONFDB.Entities.Role entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			if (CanDeepLoad(entity, "List<User>|UserCollection", deepLoadType, innerList)) 
			{
				...
				entity.UserCollection = DataRepository.UserProvider.GetByRoleId(transactionManager, entity.Id);
		...
		internal override bool DeepSave(TransactionManager transactionManager, CONFDB.Entities.Role entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
