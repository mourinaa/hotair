...
/*
	...
	Important: Do not modify this file. Edit the file SqlRatedCdrProvider.cs instead.
*/
...
namespace CONFDB.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlRatedCdrProviderBase : RatedCdrProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlRatedCdrProviderBase"/> instance.
		/// </summary>
		public SqlRatedCdrProviderBase()
		{
		}
	...
	public SqlRatedCdrProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Guid _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(RatedCdr)
					,_id);
		...
		public override CONFDB.Entities.TList<RatedCdr> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new CONFDB.Entities.TList<RatedCdr>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@ConferenceStartTime", DbType.DateTime, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ConferenceEndTime", DbType.DateTime, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ConferenceElapsedTime", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@BridgeId", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@RetailTotalCredit", DbType.Decimal, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@SeeVoghMeetingId", DbType.AnsiString, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("conferencestarttime ") || clause.Trim().StartsWith("conferencestarttime="))
				{
					database.SetParameterValue(commandWrapper, "@ConferenceStartTime", 
						clause.Trim().Remove(0,19).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("conferenceendtime ") || clause.Trim().StartsWith("conferenceendtime="))
				{
					database.SetParameterValue(commandWrapper, "@ConferenceEndTime", 
						clause.Trim().Remove(0,17).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("conferenceelapsedtime ") || clause.Trim().StartsWith("conferenceelapsedtime="))
				{
					database.SetParameterValue(commandWrapper, "@ConferenceElapsedTime", 
				...
				if (clause.Trim().StartsWith("retailtotalcredit ") || clause.Trim().StartsWith("retailtotalcredit="))
				{
					database.SetParameterValue(commandWrapper, "@RetailTotalCredit", 
						clause.Trim().Remove(0,17).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			CONFDB.Entities.TList<RatedCdr> rows = new CONFDB.Entities.TList<RatedCdr>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of CONFDB.Entities.RatedCdr objects.</returns>
		public override CONFDB.Entities.TList<RatedCdr> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Find_Dynamic", typeof(RatedCdrColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of CONFDB.Entities.RatedCdr objects.</returns>
		public override CONFDB.Entities.TList<RatedCdr> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByAccessTypeId(TransactionManager transactionManager, System.Int32 _accessTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByAccessTypeId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AccessTypeId", DbType.Int32, _accessTypeId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAccessTypeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAccessTypeId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByBridgeId(TransactionManager transactionManager, System.Int32 _bridgeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByBridgeId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@BridgeId", DbType.Int32, _bridgeId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByBridgeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByBridgeId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByWholesalerId(TransactionManager transactionManager, System.String _wholesalerId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByWholesalerId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.RatedCdr GetById(TransactionManager transactionManager, System.Guid _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Guid, _id);
			
			IDataReader reader = null;
			CONFDB.Entities.TList<RatedCdr> tmp = new CONFDB.Entities.TList<RatedCdr>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByConferenceIdBridgeIdWholesalerId(TransactionManager transactionManager, System.String _conferenceId, System.Int32 _bridgeId, System.String _wholesalerId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByConferenceIdBridgeIdWholesalerId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByWholesalerIdModeratorId(TransactionManager transactionManager, System.String _wholesalerId, System.Int32 _moderatorId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByWholesalerIdModeratorId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByModeratorId(TransactionManager transactionManager, System.Int32 _moderatorId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByModeratorId", _useStoredProcedure);
		...
		#region GetByAccessTypeIdBridgeProductRateId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByAccessTypeIdBridgeProductRateId(TransactionManager transactionManager, System.Int32 _accessTypeId, System.Int32 _bridgeProductRateId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByAccessTypeIdBridgeProductRateId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AccessTypeId", DbType.Int32, _accessTypeId);
				database.AddInParameter(commandWrapper, "@BridgeProductRateId", DbType.Int32, _bridgeProductRateId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAccessTypeIdBridgeProductRateId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAccessTypeIdBridgeProductRateId", tmp));
			}
			finally 
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByWholesalerIdStartTimeEndTime(TransactionManager transactionManager, System.String _wholesalerId, System.DateTime _startTime, System.DateTime _endTime, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByWholesalerIdStartTimeEndTime", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByReferenceNumber(TransactionManager transactionManager, System.String _referenceNumber, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByReferenceNumber", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByBilledDate(TransactionManager transactionManager, System.DateTime? _billedDate, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByBilledDate", _useStoredProcedure);
		...
		#region GetByUniqueConferenceId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override CONFDB.Entities.TList<RatedCdr> GetByUniqueConferenceId(TransactionManager transactionManager, System.String _uniqueConferenceId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_GetByUniqueConferenceId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@UniqueConferenceId", DbType.AnsiString, _uniqueConferenceId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByUniqueConferenceId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByUniqueConferenceId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<CONFDB.Entities.RatedCdr> entities)
		{
			...
			bulkCopy.DestinationTableName = "RatedCDR";
			...
			DataColumn col5 = dataTable.Columns.Add("ModeratorCode", typeof(System.String));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("PassCode", typeof(System.String));
			col6.AllowDBNull = false;		
			DataColumn col7 = dataTable.Columns.Add("ModeratorName", typeof(System.String));
			col7.AllowDBNull = true;		
			DataColumn col8 = dataTable.Columns.Add("Moderator", typeof(System.Int32));
			col8.AllowDBNull = false;		
			DataColumn col9 = dataTable.Columns.Add("ExternalCustomerNumber", typeof(System.String));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("ExternalModeratorNumber", typeof(System.String));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("ReferenceNumber", typeof(System.String));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("ConferenceStartTime", typeof(System.DateTime));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("ConferenceEndTime", typeof(System.DateTime));
			col13.AllowDBNull = true;		
			DataColumn col14 = dataTable.Columns.Add("ConferenceElapsedTime", typeof(System.Int32));
			...
			DataColumn col17 = dataTable.Columns.Add("ElapsedTime", typeof(System.Int32));
			col17.AllowDBNull = false;		
			DataColumn col18 = dataTable.Columns.Add("BridgeID", typeof(System.Int32));
			col18.AllowDBNull = false;		
			DataColumn col19 = dataTable.Columns.Add("UniqueConferenceID", typeof(System.String));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("AuxiliaryConferenceID", typeof(System.String));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("DNIS", typeof(System.String));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("DialNumber", typeof(System.String));
			col22.AllowDBNull = true;		
			DataColumn col23 = dataTable.Columns.Add("ANI", typeof(System.String));
			col23.AllowDBNull = true;		
			DataColumn col24 = dataTable.Columns.Add("ParticipantName", typeof(System.String));
			col24.AllowDBNull = true;		
			DataColumn col25 = dataTable.Columns.Add("Destination", typeof(System.String));
			col25.AllowDBNull = true;		
			DataColumn col26 = dataTable.Columns.Add("AccessTypeID", typeof(System.Int32));
			col26.AllowDBNull = false;		
			DataColumn col27 = dataTable.Columns.Add("ConnectProductRateID", typeof(System.Int32));
			col27.AllowDBNull = false;		
			DataColumn col28 = dataTable.Columns.Add("BridgeProductRateID", typeof(System.Int32));
			col28.AllowDBNull = false;		
			DataColumn col29 = dataTable.Columns.Add("LDProductRateID", typeof(System.Int32));
			col29.AllowDBNull = false;		
			DataColumn col30 = dataTable.Columns.Add("ProductRateTaxableValue", typeof(System.Int32));
			col30.AllowDBNull = false;		
			DataColumn col31 = dataTable.Columns.Add("CustomerTaxableValue", typeof(System.Int32));
			col31.AllowDBNull = false;		
			DataColumn col32 = dataTable.Columns.Add("WSTaxableValue", typeof(System.Int32));
			col32.AllowDBNull = false;		
			DataColumn col33 = dataTable.Columns.Add("RetailConnectCharge", typeof(System.Decimal));
			col33.AllowDBNull = true;		
			DataColumn col34 = dataTable.Columns.Add("RetailBridgeRate", typeof(System.Decimal));
			col34.AllowDBNull = true;		
			DataColumn col35 = dataTable.Columns.Add("RetailLDRate", typeof(System.Decimal));
			col35.AllowDBNull = true;		
			DataColumn col36 = dataTable.Columns.Add("RetailCurrency", typeof(System.String));
			col36.AllowDBNull = true;		
			DataColumn col37 = dataTable.Columns.Add("RetailBillingInterval", typeof(System.Int32));
			col37.AllowDBNull = false;		
			DataColumn col38 = dataTable.Columns.Add("RetailTotalConnectCharge", typeof(System.Decimal));
			col38.AllowDBNull = true;		
			DataColumn col39 = dataTable.Columns.Add("RetailTotalBridge", typeof(System.Decimal));
			col39.AllowDBNull = true;		
			DataColumn col40 = dataTable.Columns.Add("RetailTotalLD", typeof(System.Decimal));
			col40.AllowDBNull = true;		
			DataColumn col41 = dataTable.Columns.Add("RetailTotal", typeof(System.Decimal));
			col41.AllowDBNull = true;		
			DataColumn col42 = dataTable.Columns.Add("RetailTotalCredit", typeof(System.Decimal));
			col42.AllowDBNull = true;		
			DataColumn col43 = dataTable.Columns.Add("RetailLocalTaxRate", typeof(System.Decimal));
			col43.AllowDBNull = true;		
			DataColumn col44 = dataTable.Columns.Add("RetailFederalTaxRate", typeof(System.Decimal));
			col44.AllowDBNull = true;		
			DataColumn col45 = dataTable.Columns.Add("RetailLocalTax", typeof(System.Decimal));
			col45.AllowDBNull = true;		
			DataColumn col46 = dataTable.Columns.Add("RetailFederalTax", typeof(System.Decimal));
			col46.AllowDBNull = true;		
			DataColumn col47 = dataTable.Columns.Add("RetailTotalTax", typeof(System.Decimal));
			col47.AllowDBNull = true;		
			DataColumn col48 = dataTable.Columns.Add("WSConnectCharge", typeof(System.Decimal));
			col48.AllowDBNull = true;		
			DataColumn col49 = dataTable.Columns.Add("WSBridgeRate", typeof(System.Decimal));
			col49.AllowDBNull = true;		
			DataColumn col50 = dataTable.Columns.Add("WSLDRate", typeof(System.Decimal));
			col50.AllowDBNull = true;		
			DataColumn col51 = dataTable.Columns.Add("WSCurrency", typeof(System.String));
			col51.AllowDBNull = true;		
			DataColumn col52 = dataTable.Columns.Add("WSBillingInterval", typeof(System.Int32));
			col52.AllowDBNull = false;		
			DataColumn col53 = dataTable.Columns.Add("WSTotalConnectCharge", typeof(System.Decimal));
			col53.AllowDBNull = true;		
			DataColumn col54 = dataTable.Columns.Add("WSTotalBridge", typeof(System.Decimal));
			col54.AllowDBNull = true;		
			DataColumn col55 = dataTable.Columns.Add("WSTotalLD", typeof(System.Decimal));
			col55.AllowDBNull = true;		
			DataColumn col56 = dataTable.Columns.Add("WSTotal", typeof(System.Decimal));
			col56.AllowDBNull = true;		
			DataColumn col57 = dataTable.Columns.Add("WSLocalTaxRate", typeof(System.Decimal));
			col57.AllowDBNull = true;		
			DataColumn col58 = dataTable.Columns.Add("WSFederalTaxRate", typeof(System.Decimal));
			col58.AllowDBNull = true;		
			DataColumn col59 = dataTable.Columns.Add("WSLocalTax", typeof(System.Decimal));
			col59.AllowDBNull = true;		
			DataColumn col60 = dataTable.Columns.Add("WSFederalTax", typeof(System.Decimal));
			col60.AllowDBNull = true;		
			DataColumn col61 = dataTable.Columns.Add("WSTotalTax", typeof(System.Decimal));
			col61.AllowDBNull = true;		
			DataColumn col62 = dataTable.Columns.Add("BillingStatus", typeof(System.Int16));
			col62.AllowDBNull = true;		
			DataColumn col63 = dataTable.Columns.Add("BilledDate", typeof(System.DateTime));
			col63.AllowDBNull = true;		
			DataColumn col64 = dataTable.Columns.Add("ProcessedDate", typeof(System.DateTime));
			col64.AllowDBNull = false;		
			DataColumn col65 = dataTable.Columns.Add("SeeVoghMeetingID", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("ConferenceStartTime", "ConferenceStartTime");
			bulkCopy.ColumnMappings.Add("ConferenceEndTime", "ConferenceEndTime");
			bulkCopy.ColumnMappings.Add("ConferenceElapsedTime", "ConferenceElapsedTime");
			...
			bulkCopy.ColumnMappings.Add("RetailTotalCredit", "RetailTotalCredit");
			...
			foreach(CONFDB.Entities.RatedCdr entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ConferenceStartTime"] = entity.ConferenceStartTime.HasValue ? (object) entity.ConferenceStartTime  : System.DBNull.Value;
							
				
					row["ConferenceEndTime"] = entity.ConferenceEndTime.HasValue ? (object) entity.ConferenceEndTime  : System.DBNull.Value;
							
				
					row["ConferenceElapsedTime"] = entity.ConferenceElapsedTime.HasValue ? (object) entity.ConferenceElapsedTime  : System.DBNull.Value;
					...
					row["RetailTotalCredit"] = entity.RetailTotalCredit.HasValue ? (object) entity.RetailTotalCredit  : System.DBNull.Value;
					...
					row["ProcessedDate"] = entity.ProcessedDate;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, CONFDB.Entities.RatedCdr entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@ConferenceStartTime", DbType.DateTime, (entity.ConferenceStartTime.HasValue ? (object) entity.ConferenceStartTime  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@ConferenceEndTime", DbType.DateTime, (entity.ConferenceEndTime.HasValue ? (object) entity.ConferenceEndTime  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@ConferenceElapsedTime", DbType.Int32, (entity.ConferenceElapsedTime.HasValue ? (object) entity.ConferenceElapsedTime  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@BridgeId", DbType.Int32, entity.BridgeId );
			...
			database.AddInParameter(commandWrapper, "@RetailTotalCredit", DbType.Decimal, (entity.RetailTotalCredit.HasValue ? (object) entity.RetailTotalCredit  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@ProcessedDate", DbType.DateTime, entity.ProcessedDate );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, CONFDB.Entities.RatedCdr entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.pRatedCDR_Update", _useStoredProcedure);
		...
		public override DataSet GetCallSummaryForCustomer3(TransactionManager transactionManager, int start, int pageLength , System.Int32? customerId, System.DateTime? startTime, System.DateTime? endTime, System.Int32? departmentId, System.Int32? userId, System.String referenceNumber, System.String meetingName)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_GetCallSummaryForCustomer3");
			...
			database.AddInParameter(commandWrapper, "@DepartmentID", DbType.Int32,  departmentId );
			database.AddInParameter(commandWrapper, "@UserID", DbType.Int32,  userId );
			database.AddInParameter(commandWrapper, "@ReferenceNumber", DbType.AnsiString,  referenceNumber );
			database.AddInParameter(commandWrapper, "@MeetingName", DbType.AnsiString,  meetingName );
	
			
			DataSet ds = null;
			
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer3", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer3", (IEntity)null));
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public override DataSet GetCallSummaryForCustomer(TransactionManager transactionManager, int start, int pageLength , System.Int32? customerId, System.DateTime? startTime, System.DateTime? endTime, System.Int32? departmentId, System.Int32? userId, System.String referenceNumber, System.String meetingName)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_GetCallSummaryForCustomer");
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public override void SetBillingCode(TransactionManager transactionManager, int start, int pageLength , System.Int32? customerId, System.String uniqueConferenceId, System.String referenceNumber)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_SetBillingCode");
			
			database.AddInParameter(commandWrapper, "@CustomerID", DbType.Int32,  customerId );
			database.AddInParameter(commandWrapper, "@UniqueConferenceID", DbType.AnsiString,  uniqueConferenceId );
			database.AddInParameter(commandWrapper, "@ReferenceNumber", DbType.AnsiString,  referenceNumber );
	
			
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "SetBillingCode", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "SetBillingCode", (IEntity)null));
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public override DataSet GetCallDetailsForCustomer(TransactionManager transactionManager, int start, int pageLength , System.Int32? customerId, System.DateTime? startTime, System.DateTime? endTime, System.Int32? departmentId, System.Int32? userId, System.String referenceNumber, System.String meetingName)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_GetCallDetailsForCustomer");
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetCallDetailsForCustomer", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetCallDetailsForCustomer", (IEntity)null));
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public override DataSet GetCallSummaryForCustomer2(TransactionManager transactionManager, int start, int pageLength , System.Int32? customerId, System.DateTime? startTime, System.DateTime? endTime, System.Int32? departmentId, System.Int32? userId, System.String referenceNumber, System.String meetingName)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_GetCallSummaryForCustomer2");
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer2", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetCallSummaryForCustomer2", (IEntity)null));
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public override DataSet GetCallDetailsForModerator(TransactionManager transactionManager, int start, int pageLength , System.Int32? userId, System.DateTime? startTime, System.DateTime? endTime)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("dbo.p_RatedCDR_GetCallDetailsForModerator");
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetCallDetailsForModerator", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetCallDetailsForModerator", (IEntity)null));
