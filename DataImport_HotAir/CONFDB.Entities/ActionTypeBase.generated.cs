...
namespace CONFDB.Entities
{
	...
	[CLSCompliant(true)]
	public abstract partial class ActionTypeBase : EntityBase, CONFDB.Entities.IActionType, IEntityId<ActionTypeKey>, System.IComparable, System.ICloneable, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		public ActionTypeBase(System.String _name, System.String _description)
		{
			this.entityData = new ActionTypeEntityData();
			this.backupData = null;
		...
		public static ActionType CreateActionType(System.String _name, System.String _description)
		{
			...
			newActionType.Name = _name;
			newActionType.Description = _description;
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(ActionTypeColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ActionTypeColumn.Id, this.entityData.Id);
		...
		public virtual System.String Name
		{
			...
			set
			{
				...
				OnColumnChanging(ActionTypeColumn.Name, this.entityData.Name);
				this.entityData.Name = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ActionTypeColumn.Name, this.entityData.Name);
		...
		public virtual System.String Description
		{
			...
			set
			{
				...
				OnColumnChanging(ActionTypeColumn.Description, this.entityData.Description);
				this.entityData.Description = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ActionTypeColumn.Description, this.entityData.Description);
		...
		/// <summary>
		///	Holds a collection of Action objects
		///	which are related to this object through the relation FK_Action_ActionType
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<Action> ActionCollection
		{
			get { return entityData.ActionCollection; }
			set { entityData.ActionCollection = value; }	
		}
		...
		public virtual ActionType Copy()
		{
			...
			copy.ActionCollection = (TList<Action>) MakeCopyOf(this.ActionCollection); 
		...
		public bool IsPropertyChanged(ActionTypeColumn column)
		{
			switch(column)
			{
					case ActionTypeColumn.Id:
					return entityData.Id != _originalData.Id;
					case ActionTypeColumn.Name:
					return entityData.Name != _originalData.Name;
					case ActionTypeColumn.Description:
        ...
        {
			if (Object1 is ActionTypeBase)
				return Equals(this, (ActionTypeBase)Object1);
			else
				return false;
        }
		...
		///<summary>
		/// Determines whether the specified <see cref="ActionTypeBase"/> instances are considered equal.
		///</summary>
		...
		public static bool Equals(ActionTypeBase Object1, ActionTypeBase Object2)
		{
			// both are null
...
/*
	...
	/// <summary>
	///		The data structure representation of the 'ActionType' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class ActionTypeEntityData : ICloneable
	{
		#region Variable Declarations
		...
		private TList<Action> _actionActionTypeId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _actionActionTypeId
		/// </summary>	
		public TList<Action> ActionCollection
		{
			get
			{
				if (_actionActionTypeId == null)
				{
				_actionActionTypeId = new TList<Action>();
				}
	
				return _actionActionTypeId;
			}
			set { _actionActionTypeId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._actionActionTypeId != null)
				_tmp.ActionCollection = (TList<Action>) MakeCopyOf(this.ActionCollection); 
		...
		public void OnColumnChanging(ActionTypeColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="ActionTypeColumn"/> which has raised the event.</param>
		public void OnColumnChanged(ActionTypeColumn column)
		{
		...
		public void OnColumnChanging(ActionTypeColumn column, object value)
		{
		...
		/// <param name="column">The <see cref="ActionTypeColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public void OnColumnChanged(ActionTypeColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
	...
	public class ActionTypeKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the ActionTypeKey class.
		/// </summary>
		public ActionTypeKey(System.Int32 _id)
		{
			#region Init Properties
