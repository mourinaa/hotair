<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmailsCustomer.ascx.cs" Inherits="EmailsCustomer" %>
<asp:UpdatePanel ID="UpdatePanelEmailTemplateCustomer" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanelEmailTemplateCustomer"
