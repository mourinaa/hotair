<%@ Control Language="C#" ClassName="Wholesaler_Product_FeatureFieldsEdit" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataFeatureOptionId" DataSourceID="FeatureOptionIdFeatureOptionDataSource" DataTextField="Name" DataValueField="Id" SelectedValue='<%# Bind("FeatureOptionId") %>' AppendNullItem="false" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:FeatureOptionDataSource ID="FeatureOptionIdFeatureOptionDataSource" runat="server" SelectMethod="GetByFeatureId">
			            <Parameters>
				            <asp:ControlParameter Name="FeatureID" Type="Int32" ControlID="dataFeatureId" PropertyName="SelectedValue"></asp:ControlParameter>
			            </Parameters>
