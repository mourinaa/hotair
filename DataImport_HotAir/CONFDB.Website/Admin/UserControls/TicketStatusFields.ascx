<%@ Control Language="C#" ClassName="TicketStatusFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataAbbreviation" runat="server" Text="Abbreviation:" AssociatedControlID="dataAbbreviation" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataAbbreviation" Text='<%# Bind("Abbreviation") %>' MaxLength="2"></asp:TextBox>
				</td>
			</tr>
			<tr>
