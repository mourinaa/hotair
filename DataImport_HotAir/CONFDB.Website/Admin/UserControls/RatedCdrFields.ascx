<%@ Control Language="C#" ClassName="RatedCdrFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataReferenceNumber" Text='<%# Bind("ReferenceNumber") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataConferenceStartTime" runat="server" Text="Conference Start Time:" AssociatedControlID="dataConferenceStartTime" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataConferenceStartTime" Text='<%# Bind("ConferenceStartTime", "{0:d}") %>' MaxLength="10"></asp:TextBox><asp:ImageButton ID="cal_dataConferenceStartTime" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:return false;" /><ajaxToolkit:CalendarExtender runat="server" TargetControlID="dataConferenceStartTime" CssClass="ajaxToolkit-CalendarExtender" Format="MM/dd/yyyy" PopupButtonID="cal_dataConferenceStartTime" id="calext_dataConferenceStartTime" />
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataConferenceEndTime" runat="server" Text="Conference End Time:" AssociatedControlID="dataConferenceEndTime" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataConferenceEndTime" Text='<%# Bind("ConferenceEndTime", "{0:d}") %>' MaxLength="10"></asp:TextBox><asp:ImageButton ID="cal_dataConferenceEndTime" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:return false;" /><ajaxToolkit:CalendarExtender runat="server" TargetControlID="dataConferenceEndTime" CssClass="ajaxToolkit-CalendarExtender" Format="MM/dd/yyyy" PopupButtonID="cal_dataConferenceEndTime" id="calext_dataConferenceEndTime" />
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataConferenceElapsedTime" runat="server" Text="Conference Elapsed Time:" AssociatedControlID="dataConferenceElapsedTime" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataConferenceElapsedTime" Text='<%# Bind("ConferenceElapsedTime") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataConferenceElapsedTime" runat="server" Display="Dynamic" ControlToValidate="dataConferenceElapsedTime" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataAni" Text='<%# Bind("Ani") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataAccessTypeId" DataSourceID="AccessTypeIdAccessTypeDataSource" DataTextField="Name" DataValueField="Id" SelectedValue='<%# Bind("AccessTypeId") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataRetailTotalCredit" runat="server" Text="Retail Total Credit:" AssociatedControlID="dataRetailTotalCredit" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataRetailTotalCredit" Text='<%# Bind("RetailTotalCredit") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataRetailTotalCredit" runat="server" Display="Dynamic" ControlToValidate="dataRetailTotalCredit" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataProcessedDate" Text='<%# Bind("ProcessedDate", "{0:d}") %>' MaxLength="10"></asp:TextBox><asp:ImageButton ID="cal_dataProcessedDate" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:return false;" /><ajaxToolkit:CalendarExtender runat="server" TargetControlID="dataProcessedDate" CssClass="ajaxToolkit-CalendarExtender" Format="MM/dd/yyyy" PopupButtonID="cal_dataProcessedDate" id="calext_dataProcessedDate" /><asp:RequiredFieldValidator ID="ReqVal_dataProcessedDate" runat="server" Display="Dynamic" ControlToValidate="dataProcessedDate" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
