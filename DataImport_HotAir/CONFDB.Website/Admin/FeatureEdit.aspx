<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="FeatureEdit.aspx.cs" Inherits="FeatureEdit" Title="Feature Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Feature - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="FeatureDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/FeatureFields.ascx" />
			</EditItemTemplatePaths>
		...
		<asp:Panel ID="FeatureOptionPanel2" runat="server" CssClass="collapsePanelHeader"> 
			<div style="padding:5px; cursor: pointer; vertical-align: middle;">
				...
				<div style="float: left; padding-left: 5px;font-weight:bold;">Feature Option Details</div>
		...
		<data:EntityGridView ID="GridViewFeatureOption" runat="server"
			...
			DataSourceID="FeatureOptionDataSource4"
			DataKeyNames="Id"
		...
		<data:FeatureOptionDataSource ID="FeatureOptionDataSource4" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:FeatureOptionFilter  Column="FeatureId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
