<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="LeadStageEdit.aspx.cs" Inherits="LeadStageEdit" Title="LeadStage Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Lead Stage - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="LeadStageDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/LeadStageFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:CompanyLeadTrackingDataSource ID="CompanyLeadTrackingDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:CompanyLeadTrackingFilter  Column="LeadStageId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
