...
public partial class ReportRevenue : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.UrlReferrer == null || Request.UrlReferrer.ToString().Contains(@"/ReportRevenue.aspx") == false)
            Session["rpt-revenue"] = null;
        ...
        // on he catch clear the session variable and query will be re-excuted
        {
            ...
            if (Session["rpt-revenue"] != null)
            {
                rptRevenueReport rpt = (rptRevenueReport)Session["rpt-revenue"];
    ...
    {
        int numOfRecs = 0;
        rptRevenueReport rpt = new rptRevenueReport();
