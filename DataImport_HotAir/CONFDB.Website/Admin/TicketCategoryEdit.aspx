<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TicketCategoryEdit.aspx.cs" Inherits="TicketCategoryEdit" Title="TicketCategory Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Ticket Category - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="TicketCategoryDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TicketCategoryFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TicketDataSource ID="TicketDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:TicketFilter  Column="TicketCategoryId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
