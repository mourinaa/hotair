<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TicketStatusEdit.aspx.cs" Inherits="TicketStatusEdit" Title="TicketStatus Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Ticket Status - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="TicketStatusDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TicketStatusFields.ascx" />
			</EditItemTemplatePaths>
		...
		<asp:Panel ID="TicketStatusHistoryPanel2" runat="server" CssClass="collapsePanelHeader"> 
			<div style="padding:5px; cursor: pointer; vertical-align: middle;">
				<div style="float: left; vertical-align: middle;"><asp:Image ID="TicketStatusHistoryImage" runat="server" ImageUrl="~/images/expand_blue.jpg"/></div>
				<div style="float: left; padding-left: 5px;">Ticket Status History Details</div>
				<div style="float: left; margin-left: 20px;"><asp:Label ID="TicketStatusHistoryLabel" runat="server" /></div>
			</div>
		</asp:Panel>	
		<asp:Panel ID="TicketStatusHistoryPanel1" runat="server" CssClass="collapsePanel" Height="0">
		<data:EntityGridView ID="GridViewTicketStatusHistory" runat="server"
			AutoGenerateColumns="False"					
			OnSelectedIndexChanged="GridViewTicketStatusHistory_SelectedIndexChanged"			 			 
			DataSourceID="TicketStatusHistoryDataSource1"
			...
			<EmptyDataTemplate>
				<b>No Ticket Status History Found! </b>
				<asp:HyperLink runat="server" ID="hypTicketStatusHistory" NavigateUrl="~/admin/TicketStatusHistoryEdit.aspx">Add New</asp:HyperLink>
			</EmptyDataTemplate>
		</data:EntityGridView>					
		
		<data:TicketStatusHistoryDataSource ID="TicketStatusHistoryDataSource1" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:TicketStatusHistoryFilter  Column="StatusId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:EntityGridView ID="GridViewTicket" runat="server"
			...
			DataSourceID="TicketDataSource2"
			DataKeyNames="Id"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:TicketDataSource ID="TicketDataSource2" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:TicketFilter  Column="StatusId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
...
<ajaxToolkit:CollapsiblePanelExtender ID="cpeTicketStatusHistory" runat="Server" TargetControlID="TicketStatusHistoryPanel1"
            ExpandControlID="TicketStatusHistoryPanel2" CollapseControlID="TicketStatusHistoryPanel2" Collapsed="True"
            TextLabelID="TicketStatusHistoryLabel" ExpandedText="(Hide Details...)" CollapsedText="(Show Details...)"
            ImageControlID="TicketStatusHistoryImage" ExpandedImage="~/images/collapse_blue.jpg" CollapsedImage="~/images/expand_blue.jpg"
