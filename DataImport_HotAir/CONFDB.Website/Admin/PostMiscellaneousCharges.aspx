<%@ Page Language="C#" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"
    CodeFile="PostMiscellaneousCharges.aspx.cs" Inherits="PostMiscellaneousCharges"
    Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanelPostMiscellaneousCharges" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <table border="0" cellpadding="3" cellspacing="1">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList runat="server" ID="dataConferenceList" Enabled="false" AutoPostBack="true"
                            Width="300px" CssClass="Normal" ToolTip="OPTIONAL: Select a moderator/conference to associate the transaction to."
                            OnSelectedIndexChanged="dataConferenceList_SelectedIndexChanged" />
                        <asp:Label ID="Label2" runat="server" CssClass="Normal" Text="OPTIONAL"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="literal">
                        <asp:Label ID="Label12" runat="server" Text="Conference Call:" />
                    </td>
                    <td colspan="3">
                        <asp:DropDownList runat="server" ID="dataConferenceCallList" Enabled="false" AutoPostBack="false"
                            Width="300px" CssClass="Normal" ToolTip="OPTIONAL: Select a specific conference call to associate the transaction to." />
                        <asp:Label ID="Label13" runat="server" CssClass="Normal" Text="OPTIONAL"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="literal">
                ...
                <tr style="display: none">
                    <td class="literal">
                        <asp:Label ID="Label14" runat="server" Text="Transaction Type:" />
                    </td>
                    <td>
                ...
                <tr>
                    <td class="literal">
                        <asp:Label ID="Label3" runat="server" Text="Miscellanous Charge Type:" />
                    </td>
                    <td>
                        <ew:MultiTextDropDownList ID="groupedDDLProductRateDisplayTypes" runat="server" DataValueField="ProductRateID"
                            DataTextFormatString="{0} - {1}" DataTextFields="ProductTypeDisplayName, ProductRateDisplayName"
                            Width="300px" CssClass="Normal" 
                            ToolTip="List of miscellaneous transactions types are provided below." 
                            onselectedindexchanged="groupedDDLProductRateDisplayTypes_SelectedIndexChanged" 
                            AutoPostBack="True">
                        </ew:MultiTextDropDownList>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic"
                            ControlToValidate="groupedDDLProductRateDisplayTypes" ErrorMessage="Required"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="literal">
                    ...
                    <td>
                        <ew:NumericBox ID="numQuantity" runat="server" CssClass="Normal" PositiveNumber="True"
                            RealNumber="False" TruncateLeadingZeros="true" 
                            ToolTip="Enter the quantity." Width="300px" AutoPostBack="True" 
                            ontextchanged="numQuantity_TextChanged"></ew:NumericBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic"
                            ControlToValidate="numQuantity" ErrorMessage="Required"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator1" runat="server" ValueToCompare="0"
                            ControlToValidate="numQuantity" ErrorMessage="Value must be greater then 1" Operator="GreaterThan"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <asp:CompareValidator ID="CompareValidator2" runat="server" ValueToCompare="0.00"
                            ControlToValidate="txtRetailAmount" ErrorMessage="Must enter positive number"
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanelPostMiscellaneousCharges"
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="CustomerTransactionPanel1" runat="server" CssClass="collapsePanel"
                ...
                <data:EntityGridView ID="gvCustomerTransactions" runat="server" AutoGenerateColumns="False"
                    DataKeyNames="Id" AllowMultiColumnSorting="false" ExcelExportFileName="Export_CustomerTransaction.xls"
    ...
    <asp:Panel ID="CustomerTransactionTypePanel1" runat="server" CssClass="collapsePanel"
        ...
        <data:CustomerTransactionTypeDataSource ID="CustomerTransactionTypeDataSource" runat="server"
            ...
            <Parameters>
                <data:CustomParameter Name="WhereClause" Value="Visible=1 AND (ID=6 OR ID=7)" ConvertEmptyStringToNull="false" />
