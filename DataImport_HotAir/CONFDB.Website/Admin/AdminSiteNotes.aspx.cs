...
public partial class AdminSiteNotes : System.Web.UI.Page
{	
    protected void Page_Load(object sender, EventArgs e)
	{
		FormUtil.RedirectAfterUpdate(GridView1, "AdminSiteNotes.aspx?page={0}");
	...
	{        
        ...
        CONFDB.Entities.AdminSiteNotes content 
			= CONFDB.Data.DataRepository.AdminSiteNotesProvider.GetById(key);
