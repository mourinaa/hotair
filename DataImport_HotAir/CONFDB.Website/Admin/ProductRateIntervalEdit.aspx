<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ProductRateIntervalEdit.aspx.cs" Inherits="ProductRateIntervalEdit" Title="ProductRateInterval Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Product Rate Interval - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="ProductRateIntervalDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ProductRateIntervalFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>ProductRateInterval not found!</b>
			</EmptyDataTemplate>
		...
		<data:ProductRateDataSource ID="ProductRateDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ProductRateFilter  Column="ProductRateIntervalId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
