<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TicketPriorityEdit.aspx.cs" Inherits="TicketPriorityEdit" Title="TicketPriority Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Ticket Priority - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="TicketPriorityDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TicketPriorityFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TicketDataSource ID="TicketDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:TicketFilter  Column="TicketPriorityId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
