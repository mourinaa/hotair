<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="CompanyInfoEdit.aspx.cs" Inherits="CompanyInfoEdit" Title="CompanyInfo Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Company Info - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="CompanyInfoDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/CompanyInfoFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:CompanyLeadTrackingDataSource ID="CompanyLeadTrackingDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:CompanyLeadTrackingFilter  Column="CompanyInfoId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
