<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="LeadPeriodEdit.aspx.cs" Inherits="LeadPeriodEdit" Title="LeadPeriod Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Lead Period - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="LeadPeriodDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/LeadPeriodFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:LeadPeriodDataSource ID="LeadPeriodDataSource" runat="server"
		...
		<data:CompanyLeadTrackingDataSource ID="CompanyLeadTrackingDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:CompanyLeadTrackingFilter  Column="LeadPeriodId" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
